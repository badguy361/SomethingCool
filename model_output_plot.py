...
def model_ouput_plot(input_path,output_path,second_interval=60*30):
    ...
    fig.savefig(f"{output_path}/Sleep_Quality.png",dpi=300)

if __name__ == '__main__':
    model_ouput_plot(input_path="upload/final_data/output.csv",output_path="static/images",second_interval=60*20)